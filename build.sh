...
${nuget_cmd} install src/OriginStamp.Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/OriginStamp.Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/OriginStamp.Client.dll \
-recurse:'src/OriginStamp.Client/*.cs' \
-doc:bin/OriginStamp.Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/OriginStamp.Client.dll was created successfully"
fi
