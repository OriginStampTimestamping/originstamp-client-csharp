...
namespace OriginStamp.Client.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DefaultOfDownloadLinkResponse :  IEquatable<DefaultOfDownloadLinkResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DefaultOfDownloadLinkResponse" /> class.
        /// </summary>
        ...
        public DefaultOfDownloadLinkResponse(DownloadLinkResponse data = default(DownloadLinkResponse), int? errorCode = default(int?), string errorMessage = default(string))
        {
            this.Data = data;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DefaultOfDownloadLinkResponse {\n");
        ...
        {
            return this.Equals(input as DefaultOfDownloadLinkResponse);
        }

        /// <summary>
        /// Returns true if DefaultOfDownloadLinkResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DefaultOfDownloadLinkResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DefaultOfDownloadLinkResponse input)
        {
            if (input == null)
                return false;
